...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/auth/google/callback": {
            "get": {
                ...
                "responses": {
                    "302": {
                        "description": "Redirects to the failure URL with error code as query parameter. Available code (INTERNAL_SERVER_ERROR, INVALID_STATE, PROVIDER_ERROR, TOKEN_EXCHANGE_FAILED, INVALID_CALLBACK, FAILED_CALLBACK, USER_STATUS_INACTIVE, USER_STATUS_BANNED)",
                        "schema": {
                            "type": "string"
                        }
                    }
        ...
        "/permission": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Permissions fetched successfully. Available code (SUCCESS)",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.BaseSwaggerResponse"
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/response.PermissionModule"
                                            }
                                        }
                                    }
                                }
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/response.ListRoleResponse"
                                            }
                                        }
                                    }
                                }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.CreateUpdateRoleRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Role created successfully. Available code (CREATED)",
                        "schema": {
                            "$ref": "#/definitions/response.BaseSwaggerEmptyResponse"
                        }
                    },
                    ...
                    "422": {
                        "description": "Role name already exists. Available code (ROLE_NAME_EXISTS)",
                        "schema": {
                            "$ref": "#/definitions/response.BaseSwaggerEmptyResponse"
                        }
                    },
        ...
        "/role/{id}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Role detail fetched successfully. Available code (DETAIL_FETCHED)",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.BaseSwaggerResponse"
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/response.DetailRoleResponse"
                                        }
                                    }
                                }
                            ]
            ...
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "Role updated successfully. Available code (UPDATED)",
                        "schema": {
                            "$ref": "#/definitions/response.BaseSwaggerEmptyResponse"
                        }
                    },
                    ...
                    "422": {
                        "description": "Role not found or name already exists. Available code (ROLE_NOT_FOUND, ROLE_NAME_EXISTS)",
                        "schema": {
                            "$ref": "#/definitions/response.BaseSwaggerEmptyResponse"
                        }
                    },
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "Role deleted successfully. Available code (DELETED)",
                        "schema": {
                            "$ref": "#/definitions/response.BaseSwaggerEmptyResponse"
                        }
                    },
        ...
        "/tenant/{id}/users": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "List fetched successfully. Available code (LIST_FETCHED)",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.BasePaginationSwaggerResponse"
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/response.ListTenantUserResponse"
                                            }
                                        }
                                    }
                                }
        ...
        "/tenant/{id}/users/{user_id}": {
            "put": {
                ...
                "operationId": "tenant-user-assign-role",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Tenant ID",
                    ...
                    {
                        "description": "Assign User Role Payload",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.AssignUserRoleRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "User role assigned successfully. Available code (UPDATED)",
                        "schema": {
                            "$ref": "#/definitions/response.BaseSwaggerEmptyResponse"
                        }
                    },
            ...
            "delete": {
                ...
                "operationId": "tenant-user-remove",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Tenant ID",
                ...
                "responses": {
                    "200": {
                        "description": "User removed successfully. Available code (DELETED)",
                        "schema": {
                            "$ref": "#/definitions/response.BaseSwaggerEmptyResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request. Available code (INVALID_PARAM_ID)",
                        "schema": {
                            "$ref": "#/definitions/response.BaseSwaggerEmptyResponse"
                        }
                    },
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "collectionFormat": "csv",
                        "description": "Tenant IDs (comma-separated UUIDs)",
                        "name": "tenant_ids",
                        "in": "query"
                    },
                    {
                        ...
                        "collectionFormat": "csv",
                        "description": "Role IDs (comma-separated UUIDs)",
                        "name": "role_ids",
                        "in": "query"
                    }
                ],
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/response.ListUserTenantResponse"
                                            }
                                        }
                                    }
                                }
    ...
    "definitions": {
        ...
        "response.ListTenantUserResponse": {
            "type": "object",
            "properties": {
                "assigned_date": {
                    "type": "string",
        ...
        "response.ListUserTenantResponse": {
            "type": "object",
            "properties": {
                "assigned_date": {
                    "type": "string",
                ...
                "tenant": {
                    "$ref": "#/definitions/response.TenantUserListResponse"
                }
            }
        },
        ...
        "response.TenantUserListResponse": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "string",
